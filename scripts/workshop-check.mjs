...
try {
  ...
  await page.click('#btn-workshop-home');
  ...
  await page.click('#btn-workshop-home'); await page.click('#workshop-presets button:first-child'); await page.click('#workshop-save');
  ...
  await page.click('#btn-workshop-home'); await page.waitForTimeout(300);
