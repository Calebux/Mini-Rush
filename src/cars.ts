 ...
 * (grip, launch, nitro, slide) while you save for something with a top end.
 * `fast` is the coin ladder proper, `hyper` the NIM market supercars.
 */
...
export const CARS: CarSpec[] = [
  ...
  { id: 'rush-one', name: 'RUSH ONE', blurb: 'Your chassis. Your build. Made in the workshop.', class: 'fast', color: 0xffc531, model: 300, speed: 1, accel: 1, grip: 1, nitro: 1, price: 0 }
];
